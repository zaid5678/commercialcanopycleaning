    ...
    <PageTransition>
      ...
      <section className="pt-28 sm:pt-36 pb-20 min-h-screen">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-heading text-5xl sm:text-6xl text-white leading-none mb-6">Cookie Policy</h1>
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="font-body text-white/40 text-sm max-w-sm">Our cookie policy is being drafted. This site uses only essential session storage for the emergency banner dismissal — no tracking cookies.</p>
